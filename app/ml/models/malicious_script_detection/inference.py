...
def classify_script(model_path, script_path):
    ...
    inputs = tokenizer(script_content, return_tensors="pt", padding='max_length', truncation=True, max_length=4096)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Classify a PowerShell script as Benign or Malicious.")
    parser.add_argument("--model_path", type=str, default="./saved_model", help="Path to the trained PyTorch model directory.")
    parser.add_argument("--script_path", type=str, required=True, help="Path to the PowerShell script to test.")
